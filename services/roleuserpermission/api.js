...
export const fetchRoleUserPermissions = async (paginationData) => {
    try {
        ...
        console.error('Error fetching roleuserpermission:', error);
        throw error;
    }
};
...
export const bulkDeleteRoles = async (selectedRoleIds) => {
    try {
        ...
        console.error('Failed to delete selected roleuserpermission:', error);
        throw error;
    }
};

// Fungsi untuk memperbarui data produk
export const updateExistingRole = async (roleuserpermission) => {
    try {
        const response = await axiosInstance.put(`/merchant/roleuserpermission/update/${roleuserpermission.id}`, {
            roleuserpermission: roleuserpermission.roleuserpermission,
        });
