...
const Merchant = () => {
    ...
    const handleChange = (field, value) => {
        setMerchantData((prevData) => ({
            ...prevData,
            [field]: field === 'currency_id' 
                ? parseInt(value)  // Pastikan 'currency_id' diset sebagai integer
                : ['zip', 'phone'].includes(field) && value 
                    ? value.replace(/\D/g, '')  // Hanya angka yang disimpan
                    : typeof value === 'string' 
                        ? value.trim()  // Pangkas spasi jika string
                        : value,  // Jika bukan string atau angka, simpan nilai apa adanya
        }));
    };
                ...
                <div className="card">
                    ...
                    <div className="p-fluid formgrid grid">
                        ...
                        <div className="field col-12 md:col-3">
                            ...
                            <Dropdown
                                id="currency_id"
                                value={merchantData.currency_id}
