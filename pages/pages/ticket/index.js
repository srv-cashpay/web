...
const Ticket = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const response = await axios.get(`https://103.127.134.78:8080/api/v1/employee?page=${paginationData.page}&limit=${paginationData.limit}`, {
                    headers: {
    ...
    const saveDataToApi = async () => {
        try {
            ...
            const response = await axios.post(`https://103.127.134.78:8080/api/v1/employee`, employee, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
