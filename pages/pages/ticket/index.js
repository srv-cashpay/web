...
const Ticket = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const response = await axios.get(`https://cashpay.my.id:8080/api/v1/employee?page=${paginationData.page}&limit=${paginationData.limit}`, {
                    headers: {
    ...
    const saveDataToApi = async () => {
        try {
            ...
            const response = await axios.post(`https://cashpay.my.id:8080/api/v1/employee`, employee, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
