        ...
        <Dialog visible={visible} style={{ width: '600px' }} header="Discount Details" modal className="p-fluid" footer={discountDialogFooter} onHide={hideDialog}>
            <div className="field">
                ...
                <InputText
                    ...
                    required
                    autoFocus
                    className={classNames({ 'p-invalid': submitted && !discount.discount })}
                />
                {submitted && !discount.discount && <small className="p-invalid">Discount name is required. Please provide a valid name.</small>}
            </div>
            ...
            <div className="field">
                ...
                />
                {submitted && !discount.description && <small className="p-invalid">Description is required. Please enter a discount description.</small>}
            </div>
