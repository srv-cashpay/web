...
const VerifyPage = () => {
    ...
    const handleRegister = async () => {
        ...
        try {
            const response = await axios.post(`https://cashpay.my.id:2356/verify?token=${token}`, { otp: otpCode });
    ...
    const handleResendCode = async () => {
        ...
        try {
            ...
            const response = await axios.put(`https://cashpay.my.id:2356/resend-otp?token=${token}`);
