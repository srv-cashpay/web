...
const VerifyPage = () => {
    ...
    const handleRegister = async () => {
        ...
        try {
            const response = await axios.post(`http://127.0.0.1:2356/verify?token=${token}`, { otp: otpCode });
    ...
    const handleResendCode = async () => {
        ...
        try {
            ...
            const response = await axios.put(`http://127.0.0.1:2356/resend-otp?token=${token}`);
