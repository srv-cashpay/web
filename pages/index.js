                        ...
                        <div className="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
                            <div
                                ...
                                <div className="p-3 surface-card h-full" style={{ borderRadius: '8px' }}>
                                    ...
                                    <h5 className="mb-2 text-900">Social Media</h5>
                        ...
                        <div className="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
                            <div
                                ...
                                <div className="p-3 surface-card h-full" style={{ borderRadius: '8px' }}>
                                    ...
                                    <h5 className="mb-2 text-900">Advanced Search</h5>
                        ...
                        <div className="col-12 md:col-12 lg:col-4 p-0 lg:pb-5 mt-4 lg:mt-0">
                            <div
                                ...
                                <div className="p-3 surface-card h-full" style={{ borderRadius: '8px' }}>
                                    ...
                                    <h5 className="mb-2 text-900">Introduction Feature</h5>
                        ...
                        <div className="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
                            <div
                                ...
                                <div className="p-3 surface-card h-full" style={{ borderRadius: '8px' }}>
                                    ...
                                    <h5 className="mb-2 text-900">Interactive Profiles</h5>
                        ...
                        <div className="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
                            <div
                                ...
                                <div className="p-3 surface-card h-full" style={{ borderRadius: '8px' }}>
                                    ...
                                    <h5 className="mb-2 text-900">Advanced Matching Algorithm</h5>
                        ...
                        <div className="col-12 md:col-12 lg:col-4 p-0 lg:pb-5 mt-4 lg:mt-0">
                            <div
                                ...
                                <div className="p-3 surface-card h-full" style={{ borderRadius: '8px' }}>
                                    ...
                                    <h5 className="mb-2 text-900">Boost Profile</h5>
                        ...
                        <div className="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 mt-4 lg:mt-0">
                            <div
                                ...
                                <div className="p-3 surface-card h-full" style={{ borderRadius: '8px' }}>
                                    ...
                                    <h5 className="mb-2 text-900">Real-Time Chatting</h5>
                        ...
                        <div className="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 mt-4 lg:mt-0">
                            <div
                                ...
                                <div className="p-3 surface-card h-full" style={{ borderRadius: '8px' }}>
                                    ...
                                    <h5 className="mb-2 text-900">Get New Friend</h5>
                        ...
                        <div className="col-12 md:col-12 lg:col-4 p-0 lg-4 mt-4 lg:mt-0">
                            <div
                                ...
                                <div className="p-3 surface-card h-full" style={{ borderRadius: '8px' }}>
                                    ...
                                    <h5 className="mb-2 text-900">Privacy and Secure</h5>
